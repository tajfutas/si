...
class AirPlusRadioMode(_enum_.Enum):
  # References:
...
class AirPlusSpecialMode(_enum_.Enum):
  # References:
...
class BeaconTimingMode(_enum_.Enum):
  # References:
...
class EvaluationStatus(_enum_.Enum):
  # References:
...
class FractionType(_enum_.Enum):
  # References:
...
class OperatingMode(_enum_.Enum):
  # References:
